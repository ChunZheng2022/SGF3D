...
def depth_to_lidar(idx_filename, split, dense_depth_dir, pseudo_depth_dir):
    dataset = kitti_object('../../PPKD/data/kitti_sfd_seguv_twise', split)
...
depth_to_lidar( \
    '../../PPKD/data/kitti_sfd_seguv_twise/ImageSets/trainval.txt',
    'training',
    '../../PPKD/data/kitti_sfd_seguv_twise/training/depth_dense_twise',
    '../../PPKD/data/kitti_sfd_seguv_twise/training/depth_pseudo_rgbseguv_twise'
)

print('---------------Start to generate testing pseudo point clouds---------------')
depth_to_lidar( \
    '../../PPKD/data/kitti_sfd_seguv_twise/ImageSets/test.txt',
    'testing',
    '../../PPKD/data/kitti_sfd_seguv_twise/testing/depth_dense_twise',
    '../../PPKD/data/kitti_sfd_seguv_twise/testing/depth_pseudo_rgbseguv_twise'
)