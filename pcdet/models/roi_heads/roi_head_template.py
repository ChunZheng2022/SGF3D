...
class RoIHeadTemplate(nn.Module):
    ...
    # def get_box_similar_loss(self,forward_ret_dict):
    #     loss_cfgs = self.model_cfg.LOSS_CONFIG
    ...
    #         rcnn_loss_similar = self.get_loss()
    ...
    def get_loss(self, tb_dict=None):
        ...
        rcnn_loss_similar, similar_tb_dict = self.get_box_similar_layer_loss(self.forward_ret_dict)
        rcnn_loss += rcnn_loss_similar
        tb_dict.update(similar_tb_dict)
