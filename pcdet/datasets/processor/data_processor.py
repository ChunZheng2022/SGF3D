...
class DataProcessor(object):
    ...
    def mask_points_and_boxes_outside_range_sgf(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.mask_points_and_boxes_outside_range_sgf, config=config)
    ...
    def shuffle_points_sgf(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.shuffle_points_sgf, config=config)
