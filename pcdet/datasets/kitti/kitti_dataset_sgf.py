...
class KittiDatasetSGF(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train'):
        ...
        db_info_save_path = Path(self.root_path) / ('kitti_dbinfos_%s_sgf_seguv.pkl' % split)
    ...
    def collate_batch(batch_list, _unused=False):
        ...
        for key, val in data_dict.items():
            ...
            try:
                if key in ['voxels', 'voxel_num_points', 'voxels_pseudo', 'voxel_num_points_pseudo','images']:
